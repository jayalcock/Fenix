...
ctl_start_timer(CTL_ISR_FN_t t)
{
  ...
  T0MR0 = (liblpc2000_lpc21xx_get_pclk(liblpc2000_lpc21xx_get_cclk(OSCILLATOR_CLOCK_FREQUENCY)) / 1000) - 1; /* Set timer 0 match register to generate a 1KHz interrupt */
